    ...
    <div id="generalDetail">
        <table width="100%" >
            <tr>
                ...
                <td width="30%"><div id="userID_Retrieve" align="left"></div></td>
                <td width="20%"><strong>User name:</strong></td>
                <td width="30%"><div id="userName" align="left"></div></td>
            </tr>    
            <tr>
                <td width="20%" ><strong>Name:</strong></td>
                <td width="30%"><div id="name" align="left"></div></td>
                <td width="20%"><strong>Account Type:-</strong></td>
                <td width="30%"><div id="accountType" align="left"></div></td>
            </tr>   
            <tr>
    ...
    <div id="patientDetailView">
        <table width="100%" >
            <tr>
                ...
                <td width="30%"><div align="left" id="doctorName"></div></td>
                <td width="20%"><strong>Nurse Name: </strong></td>
                <td width="30%"><div align="left" id="nurseName"></div></td>
            </tr>    
            <tr>
...
<!--    <div align="center" class="print">
        <input type="button" value="Print" onClick="PrintElem('#userDetail')" />
    </div>-->