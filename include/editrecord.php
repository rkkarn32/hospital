    ...
    <div class="generalDetail_E">
        <table width="100%" border="1px"> 
            <tr>
                ...
                <td width="32%"><input type="text" disabled="disabled" id="userID_E" name="userID_E"/></td>
                <td width="20%"><strong>User name:-</strong></td>
                <td width="21%"><input type="text" id="userName_E" disabled="disabled" name="userName_E" /></td>
            </tr>    
            <tr>
                <td width="27%" ><strong>Name:-</strong></td>
                <td width="32%"><input type="text" id="name_E" name="name_E" /></td>
