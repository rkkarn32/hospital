...
<table  width="100%" class="displaySection">
    <tr>
        ...
        <td width="30%"><input id="userID_Search" name="userID_Search" type="text" style="width: 80%" maxlength="50" tabindex="11"/></td>
        <td width="20%" ><strong>User name:-</strong></td>
        <td width="30%"><input id="userName" name="userName" type="text" style="width: 80%" maxlength="50" tabindex="11"/></td>
    </tr>    
    <tr>
        <td width="20%" ><strong>Creation Date:-</strong></td>
        <td width="30%" valign="top"><input id="accountCreationDate" name="accountCreationDate" type="date" tabindex="13" style="width: 80%"/></td>
        <td width="20%">Role </td>
        <td width="20%">
            <div>
    ...
    <tr>
        ...
        <td width="30%"><input type="text" name="txtFullName" tabindex="16" maxlength="50" style="width: 80%"/></td>
    </tr>
    <tr>
        <td width="20%"><strong>State:-</strong></td>
        <td width="30%" ><input type="text" name="txtState" tabindex="17" maxlength="50" style="width: 80%" /></td>
        <td width="20%"><strong>City:-</strong></td>
        <td width="30%"><input type="text" name="txtCity" tabindex="18" maxlength="50" style="width: 80%" /></td>
    </tr>
    <tr>
        <td width="20%"><strong>Phone Number:-</strong></td>
        <td width="30%"><input type="text" name="txtPhoneNo" tabindex="19" maxlength="50" style="width: 80%" /></td>
