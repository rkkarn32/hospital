...
<div class="nav-outer"> 
		...
		<ul class="select">
		  <li><a href="index.php"><b>Home</b><!--[if IE 7]><!--></a><!--<![endif]-->
		</li>
		</ul>
		...
		<ul class="select">
		  <li><a href="#nogo"><b>Add_Staff </b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
		</ul>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><a href="">S.N.</a>	</th>
